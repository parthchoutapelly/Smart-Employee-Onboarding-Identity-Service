...
STAGE_NAME = "policy_signoff"

def lambda_handler(event, context):
    """
    Step Functions Stage Handler: PolicySignOff
    Receives: { "employee_id": "<uuid>" }
    Updates EmployeeProfileTable onboarding_status.policy_signoff -> 'complete'
    Returns: { "employee_id": "<uuid>", "stage": "policy_signoff", "status": "complete" }
    """
