...
STAGE_NAME = "manager_intro"

def lambda_handler(event, context):
    """
    Step Functions Stage Handler: ManagerIntro
    Receives: { "employee_id": "<uuid>" }
    Updates EmployeeProfileTable onboarding_status.manager_intro -> 'complete'
    Returns: { "employee_id": "<uuid>", "stage": "manager_intro", "status": "complete" }
    """
