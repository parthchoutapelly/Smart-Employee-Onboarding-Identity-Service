...
STAGE_NAME = "it_provisioning"

def lambda_handler(event, context):
    """
    Step Functions Stage Handler: ITProvisioning
    Receives: { "employee_id": "<uuid>" }
    Updates EmployeeProfileTable onboarding_status.it_provisioning -> 'complete'
    Returns: { "employee_id": "<uuid>", "stage": "it_provisioning", "status": "complete" }
    """
